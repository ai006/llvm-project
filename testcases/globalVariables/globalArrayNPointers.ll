; ModuleID = 'globalArrayNPointers.c'
source_filename = "globalArrayNPointers.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@globalArray = dso_local global [5 x i32] [i32 1, i32 2, i32 3, i32 4, i32 5], align 4
...
define dso_local i32 @main() #0 {
  ...
  store i32* getelementptr inbounds ([5 x i32], [5 x i32]* @globalArray, i64 0, i64 0), i32** %2, align 8
...
22:                                               ; preds = %19
  ...
  %25 = getelementptr inbounds [5 x i32], [5 x i32]* @globalArray, i64 0, i64 %24
