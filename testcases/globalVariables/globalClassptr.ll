; ModuleID = 'globalClassptr.cpp'
source_filename = "globalClassptr.cpp"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

%"class.std::ios_base::Init" = type { i8 }
%class.MyClass = type { [10 x i8], i64 }
...
$_ZN7MyClass8myMethodEv = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@globalPointer = dso_local global %class.MyClass* null, align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [20 x i8] c"Hello from MyClass!\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_globalClassptr.cpp, i8* null }]
...
define dso_local noundef i32 @main() #4 {
  ...
  store %class.MyClass* %2, %class.MyClass** @globalPointer, align 8
  %3 = load %class.MyClass*, %class.MyClass** @globalPointer, align 8
  call void @_ZN7MyClass8myMethodEv(%class.MyClass* noundef nonnull align 8 dereferenceable(24) %3)
  ret i32 0
}

; Function Attrs: mustprogress noinline uwtable
define linkonce_odr dso_local void @_ZN7MyClass8myMethodEv(%class.MyClass* noundef nonnull align 8 dereferenceable(24) %0) #5 comdat align 2 {
  %2 = alloca %class.MyClass*, align 8
  store %class.MyClass* %0, %class.MyClass** %2, align 8
  %3 = load %class.MyClass*, %class.MyClass** %2, align 8
  %4 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_globalClassptr.cpp() #0 section ".text.startup" {
