...
@.str = private unnamed_addr constant [8 x i8] c"yeeerrr\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"Hello World\00", align 1

; Function Attrs: noinline nounwind uwtable
define dso_local void @foo() #0 {
  %1 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0))
  ret void
}
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0))
  ret i32 0
}
