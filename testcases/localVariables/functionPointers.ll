; ModuleID = 'functionPointers.cpp'
source_filename = "functionPointers.cpp"
...
@.str = private unnamed_addr constant [25 x i8] c"Result of add function: \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_functionPointers.cpp, i8* null }]
...
define dso_local noundef i32 @_Z16performOperationiiPFiiiE(i32 noundef %0, i32 noundef %1, i32 (i32, i32)* noundef %2) #5 {
  %4 = alloca i32, align 4
  ...
  %10 = call noundef i32 %7(i32 noundef %8, i32 noundef %9)
  ret i32 %10
}
...
define dso_local noundef i32 @main() #6 {
  ...
  store i32 (i32, i32)* @_Z3addii, i32 (i32, i32)** %2, align 8
  %4 = load i32 (i32, i32)*, i32 (i32, i32)** %2, align 8
  %5 = call noundef i32 %4(i32 noundef 5, i32 noundef 3)
  store i32 %5, i32* %3, align 4
  %6 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_functionPointers.cpp() #0 section ".text.startup" {
...
attributes #4 = { mustprogress noinline nounwind uwtable "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+neon,+outline-atomics,+v8a" }
attributes #5 = { mustprogress noinline uwtable "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+neon,+outline-atomics,+v8a" }
attributes #6 = { mustprogress noinline norecurse uwtable "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+neon,+outline-atomics,+v8a" }
