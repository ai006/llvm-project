...
@.str = private unnamed_addr constant [18 x i8] c"Addition result: \00", align 1
@.str.1 = private unnamed_addr constant [21 x i8] c"Subtraction result: \00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"Multiplication result: \00", align 1
...
define dso_local noundef i32 @main() #5 {
  ...
  %5 = call noundef i32 %4(i32 noundef 4, i32 noundef 2)
  store i32 %5, i32* %3, align 4
  %6 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0))
  ...
  store i32 (i32, i32)* @_Z8Subtractii, i32 (i32, i32)** %2, align 8
  %10 = load i32 (i32, i32)*, i32 (i32, i32)** %2, align 8
  %11 = call noundef i32 %10(i32 noundef 4, i32 noundef 2)
  store i32 %11, i32* %3, align 4
  %12 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0))
  ...
  store i32 (i32, i32)* @_Z8Multiplyii, i32 (i32, i32)** %2, align 8
  %16 = load i32 (i32, i32)*, i32 (i32, i32)** %2, align 8
  %17 = call noundef i32 %16(i32 noundef 4, i32 noundef 2)
  store i32 %17, i32* %3, align 4
  %18 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i64 0, i64 0))
...
attributes #5 = { mustprogress noinline norecurse uwtable "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+neon,+outline-atomics,+v8a" }
